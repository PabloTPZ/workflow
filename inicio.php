                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong> Formulario de inicio de Sesión</strong></h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" method="post" action="login.php"  class="login-form">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="iniciar" value="iniciar sesion" class="btn">Iniciar Sesión!</button>
                                    </div>
			                    </form>
                                ...
                                <form role="form" action="flujo2.php" method="GET" class="login-form">
                                    ...
                                    <button type="submit" name="registro" value="registro de estudiantes" class="btn">Registrarse!</button>
                                </form>
